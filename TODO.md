...
- [x] Add some form of animations to different areas of the app ( maybe add animation for buttons and/or sounds on button press... maybe vibration on button press)
...
### In progress 
- [x] Complete modal screen ( with working submit forms and fixed modal submit button)
## What's going on on the current task in progress?
= [x] Need to find a way to pass the addTask function as a prop to the modal component, without messing up the flex box layout.
